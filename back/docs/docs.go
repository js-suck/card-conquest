...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/tournaments": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sort order (use 'start_date' for ascending order, '-start_date' for descending order)",
                        "name": "Sort",
                        "in": "query"
                    },
                    {
        ...
        "/users/subscriptions/{userID}/tournaments": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/users/subscriptions/{userID}/tournaments/{tournamentID}/subscribe": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/users/subscriptions/{userID}/tournaments/{tournamentID}/unsubscribe": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
